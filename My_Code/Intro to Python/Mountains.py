...
plt.xticks(range(0, len(country_counts), 10),rotation=45)
plt.tight_layout()
plt.show()
...
plt.xticks(range(0, len(max_altitudes), 10),rotation=90)
plt.tight_layout()
plt.show()
...
plt.xticks(range(0, len(grouped_altitudes), 2), rotation=90)
plt.xlabel("Country")
